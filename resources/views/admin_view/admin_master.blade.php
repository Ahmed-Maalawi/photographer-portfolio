...
<script src="{{ asset('admin_style/js/plugins/sweetalert/sweetalert.min.js') }}"></script>
<script src="{{ asset('admin_style/js/plugins/sweetalert/sweetalert.active.js') }}"></script>
