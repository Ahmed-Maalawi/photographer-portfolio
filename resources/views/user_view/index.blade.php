        ...
        <div class="ruby-container">
            <div class="owl-carousel owl-theme">
                ...
                <div class="text-left item bg-img" data-overlay-dark="2"
                     data-background="{{ asset('user_style/img/slider/1.jpg')}}">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>Welcome to my </h4>
                                    <h1>Essam Elsharkawy Photography </h1>
                                    <p>I love to pause the wild, happy and real moments of life, just to hear their
                                        stories untold. </p>  <a href="#" class="button-primary">My works </a> <a
                                        href="{{ route('user.contact') }}" class="button-tersiyer">Contact me </a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-left item bg-img" data-overlay-dark="2"
                     data-background="{{ asset('user_style/img/slider/2.jpg') }}">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p>I am professional photographer based on El-Maadi, creating dreamscapes with
                                        black, white and shades in-between. </p>  <a href="#" class="button-primary">My
                                        works </a> <a href="{{ route('user.contact') }}" class="button-tersiyer">Contact
                                        me </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp">
                    <h2 class="section-title">Hello, I'm Essam Mohamed Soliman, a professional photographer based on
                        El-Maadi </h2>
                    <p>I love to pause the wild, happy and real moments of life, just to hear their stories untold.
                    ...
                    <ul class="list-unstyled about-list mb-30">
                        <li>
                            ...
                            <div class="about-list-text">
                                <p>Over 6 years of experience</p>
                            </div>
                        </li>
                        <li>
                            <div class="about-list-icon"><span class="ti-check"></span></div>
                            <div class="about-list-text">
                                <p>70+ successfully executed projects </p>
                            </div>
                        </li>
                        <li>
                            <div class="about-list-icon"><span class="ti-check"></span></div>
                    ...
                    <hr class="border-2"/>
                    <div class="about-bottom"><img src="{{ asset('user_style/img/signature-dark.svg') }}" alt=""
                ...
                <div class="col-md-5 offset-md-1 animate-box" data-animate-effect="fadeInUp">
                    <div class="about-img">
                        <div class="img"><img src="{{ asset('user_style/img/essam.jpg') }}" class="img-fluid" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3 mb-30 text-center">
                    ...
                    <p class="section-title2">Quverra tristique justo duis vitae diam neque nivamus aestan ateuene
                        artinaelition finibus viverra nec lacus setlie suscipe tristique. </p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-12 owl-carousel owl-theme">
                    ...
                    @foreach($news as $index => $post)
                        <div class="news {{ ($index % 2)? 'left' : ''}}">
                            ...
                            <div class="caption">
                                <h6>{{ $post['tag'] }} </h6>
                                <h4><a href="{{ route('user.blog.view.post', $post['id']) }}">{{ $post['title'] }} </a>
                                </h4>

                                <p>{!! Str::limit($post['content'], 75) !!}</p>
                                {{--                                <p>{!! nl2br($post['content'], 20) !!}</p>--}}

                                <hr class="border-2"/>
                                <div class="info-wrapper">
                                    <div class="more"><a href="{{ route('user.blog.view.post', $post['id']) }}"
                                                         class="link-btn" tabindex="0">Read Post </a></div>
                    ...
                    <div class="news">
                        ...
                        <div class="caption">
                            <h6>Resources </h6>
                            <h4><a href="post.html">Cosina announces its fastest full-frame lens, the Nokton 50mm </a>
                            </h4>
                            <p>Photographers viverra tristique duis vitae diam the neque nivamus aestan ateuene artines
                                duru setlie suscipe the fermen. </p>
                            <hr class="border-2"/>
                            <div class="info-wrapper">
            ...
            <div class="row gallery-items">
                <div class="masonry-items">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item wedding">
                        <a href="{{ asset('user_style/img/works/w2.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/w2.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item personal">
                        <a href="{{ asset('user_style/img/works/p1.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/p1.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item event">
                        <a href="{{ asset('user_style/img/works/e1.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/e1.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item personal">
                        <a href="{{ asset('user_style/img/works/p2.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/p2.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                                    <div class="gallery-masonry-item-category">Personal</div>
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item event">
                        <a href="{{ asset('user_style/img/works/e2.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/e2.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                                    <div class="gallery-masonry-item-category">Event</div>
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item wedding">
                        <a href="{{ asset('user_style/img/works/w1.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/w1.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                                    <div class="gallery-masonry-item-category">Wedding</div>
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item fashion">
                        <a href="{{ asset('user_style/img/works/f1.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/f1.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item product">
                        <a href="{{ asset('user_style/img/works/p3.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/p3.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                    ...
                    <div class="col-md-4 gallery-masonry-wrapper single-item fashion">
                        <a href="{{ asset('user_style/img/works/f2.jpg') }}" title=""
                           class="gallery-masonry-item-img-link img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"><img src="{{ asset('user_style/img/works/f2.jpg') }}"
                                                              class="img-fluid mx-auto d-block" alt=""/></div>
                                <div class="gallery-masonry-item-img"></div>
                                <div class="gallery-masonry-item-content">
                                    <div class="gallery-masonry-item-category">Fashion</div>
